		...
		<div class="card-body">
			<div class="row">
				<div class="col-12 col-md-7" style="border-right: 1px solid #d6dce1;">
					<div class="row">
						<input type="text" name="solicitud_id" id="solicitud_id" class="d-none" value="{{$solicitud->id}}">
								...
								<table class="table" id="table-productos">
									...
									<tbody id="table-productos-body">
										@foreach ($productos as $producto)
											<tr>
												<th data-productoid="{{$producto->id}}" data-productostock="{{$producto->stock}}" style="cursor: pointer" <?php if ($solicitud->status==2) { echo 'class="tr-producto"';}?>>{{$producto->nombre}}</th>
											</tr>
										@endforeach
									</tbody>
								</table>
